...
| 유형 | 방법 |
|------|------|
| 버그 수정 | [Issues](https://github.com/haksungjang/sbom-tools/issues)에서 버그를 찾아 수정 |
...
| 기능 제안 | [Discussions](https://github.com/haksungjang/sbom-tools/discussions)에서 먼저 논의 |
...
[GitHub Issues](https://github.com/haksungjang/sbom-tools/issues)를 이용해 주세요. 아래 정보를 포함하면 빠른 해결에 도움이 됩니다.
...
[GitHub Discussions](https://github.com/haksungjang/sbom-tools/discussions)에서 먼저 논의한 뒤 이슈로 이어가면 좋습니다.
